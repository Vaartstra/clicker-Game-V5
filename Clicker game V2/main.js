...
document.getElementById('purchaseBtn10').addEventListener('mouseover', () => seePrice(autoClickerPrice, 0, 0, 0, 0, false))
...
function drawFurnaceInterface() {
    ...
    ctx4.fillText('shift click to put all items in the furnace', 10,360)
...
function newBlock() {
    ...
    if (pickaxeType == 'wood') {
        ...
        createBlock(6.5, 8.5, 10, 0, 0)
    } else if (pickaxeType == 'iron') {
        createBlock(5.5, 7, 9, 9.9, 10)
    } else if (pickaxeType == 'gold') {
        createBlock(4.5, 6.5, 8.5, 9.6, 10)
    } else if (pickaxeType == 'diamond') {
        createBlock(4, 6, 8, 9, 9.9)
    }
